...
const View = ({ params }: { params: string }) => {
  ...
  return (
    <div className="">
      <Navbar />
      {loading ? (
        <div className="my-10 text-[#295bb1] text-xl grid place-items-center w-full">
          ...
          <div className="bg-[#29A0B1]/10 w-full grid mx-auto min-h-screen py-10">
            <form className="w-full block mx-auto h-full px-6 md:px-0 overflow-x-hidden">
              <div className="flex md:flex-row flex-col justify-center items-center max-w-3xl mx-auto">
                <div className="border-t-8 rounded-md my-6 border-[#295bb1] bg-white max-w-2xl shadow w-full grid place-items-center mx-auto">
                  <div className="w-full border border-gray-300">
                    <div className="w-full px-6 py-2">
                      <div
                        className="text-3xl outline-none font-bold  border-b 
      focus:border-b-2 border-gray-200 pt-3 pb-2 w-full focus:border-[#295bb1]"
                      >
                        {forms && forms.title}
                      </div>
                    </div>
                    <div className="w-full px-6 py-1 mb-6">
                      <div
                        className="text-base outline-none font-medium  border-b 
      focus:border-b-2 border-gray-200 focus:border-[#295bb1] py-1 w-full"
                      >
                    ...
                    >
                      ...
                      >
                        <div className="w-full md:px-6 px-2 flex md:flex-row flex-col md:justify-between justify-center items-center gap-8 py-6">
                          <div className="text-base px-4 outline-none border-b bg-gray-100 focus:border-b-2 border-gray-400 pt-3 pb-2 w-full focus:border-[#295bb1]">
                            {ques.title}
                          </div>
                        </div>
              ...
              <div>
                <div className="grid place-items-center w-auto mx-auto">
                  <button
                    type="submit"
                    className="bg-[#295bb1] font-bold uppercase text-white px-6 py-3 rounded"
                  >
                    Submit
                  </button>
                </div>
